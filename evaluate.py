...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='/mnt/tim/VAE_for_Pneumonia/outputs/checkpoint_epoch_80.pth',
    ...
    parser.add_argument('--output_dir', type=str, default='/mnt/tim/VAE_for_Pneumonia/evaluation_mean_0.01',
